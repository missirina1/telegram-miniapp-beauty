  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <nav className="flex justify-around border-t bg-white py-2">
        ...
        <Link
          to="/master/schedule"
          className={current.includes('schedule') ? 'text-blue-600' : ''}
        >
          <Calendar size={24} />
        </Link>
        ...
        <Link
          ...
          className={current.includes('appointments') ? 'text-blue-600' : ''}
        >
          <List size={24} />
        </Link>
        ...
        <Link
          to="/master/profile"
          className={current.includes('profile') ? 'text-blue-600' : ''}
        >
          <User size={24} />
        </Link>
      </nav>
